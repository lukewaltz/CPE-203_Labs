...
import static part3.Country.*;
import static part3.Sector.*;
...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println(countryWithHighestCH4InYear(countries, 2000).getName());
        countryWithHighestChangeInEmissions(countries, 1988, 2012);
        sectorWithBiggestChangeInEmissions(sectors, 1988, 2012);
    }
