...
public class TestCases
{
   ...
   {
      //makes array containing one zero
      int number[] = {0};

      //returns lambda expression that adds 1 to the value at 0th index
      return () -> number[0]++;
   }
   ...
   public void testExercise4()
   {
      ...
      //maps a list to a function (maps list Numbers to Lambda expr x->x+n;)
