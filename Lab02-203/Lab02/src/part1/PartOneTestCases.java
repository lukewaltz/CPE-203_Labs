...
public class PartOneTestCases {
    ...
    public void testYearWithHighestEmissions01() {
        ...
        // Check that the method works as expected
        assertEquals(1981, Util.getYearWithHighestEmissions(sector));
    }
    ...
    public void testYearWithHighestEmissions1() {
        ...
        // Check that the method works as expected
        assertEquals(1971, Util.getYearWithHighestEmissions(country));
    }
    ...
    public void testYearWithHighestEmissions2() {
        ...
        // Check that the method works as expected
        assertEquals(1981, Util.getYearWithHighestEmissions(country));
    }
